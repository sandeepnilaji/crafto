          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="h-[100px]">
              ...
              <textarea
                id="text"
                {...register("text")}
                className="text-neutral-950 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-600 focus:border-gray-500"
              />
              {errors.text && (
